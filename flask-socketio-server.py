...
socketio = SocketIO(app, cors_allow_origins='*',async_mode="threading")
...
def message_callback(methods=['GET','POST']):
    print("message was received!!")


@socketio.on('my event')
def handle_event(data, methods=['GET','POST']):
    print('Message: ' + str(data))
    socketio.emit('my response', data, callback=message_callback)
...
# class User_Chat(threading.Thread):
#     def __init__(self):
#         threading.Thread.__init__(self)
#
#     def run(self):
